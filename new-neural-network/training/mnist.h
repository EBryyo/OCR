...
#define TRAIN_IMAGE "./training/data/train-images.idx3-ubyte"
#define TRAIN_LABEL "./training/data/train-labels.idx1-ubyte"
#define TEST_IMAGE "./training/data/t10k-images.idx3-ubyte"
#define TEST_LABEL "./training/data/t10k-labels.idx1-ubyte"
